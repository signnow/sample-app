...
namespace Samples\EmbeddedSenderWithFormDGAdjunct;
...
class SampleController implements SampleControllerInterface
{
     ...
     */
    private const DOCUMENT_GROUP_TEMPLATE_ID = 'e486ebf3fb814d55888bcbf75ceaf62b6db0de5a';

    public function handleGet(Request $request): Response
    {
        return new Response(
            view('EmbeddedSenderWithFormDGAdjunct::index')->render(),
            200,
            [
    ...
    private function createEmbeddedSendingUrl(ApiClient $apiClient, string $documentGroupId): array
    {
        ...
        $redirectUrl = config('app.url')
            . '/samples/EmbeddedSenderWithFormDGAdjunct?' .
            http_build_query([
                'page' => 'status-page',
