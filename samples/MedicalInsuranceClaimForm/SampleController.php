...
namespace Samples\MedicalInsuranceClaimForm;
...
class SampleController implements SampleControllerInterface
{
    ...
    {
        return new Response(
            view('MedicalInsuranceClaimForm::index')->render(),
            200,
            [
     ...
     * - If action is 'create-embedded-editor', clones template, pre-fills fields,
    ...
    private function getEmbeddedInviteLink(
        ...
        $redirectUrl = config('app.url')
            . '/samples/MedicalInsuranceClaimForm?page=download-container&document_id='
            . $documentId;
