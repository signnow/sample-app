...
namespace Samples\EmbeddedSignerPatientIntakeForm;
...
{
    private const TEMPLATE_ID = '4078899bbf4446eea7ae0e157e742bbd93be191f';
    ...
    public function handleGet(Request $request): Response
    {
        ...
        if ($page === 'download-container') {
            return new Response(
                view('EmbeddedSignerPatientIntakeForm::index')->render(),
                200,
                [
    ...
    private function getEmbeddedInviteLink(
        ...
        $redirectUrl = config('app.url')
            . '/samples/EmbeddedSignerPatientIntakeForm?page=download-container&document_id='
            . $documentId;
