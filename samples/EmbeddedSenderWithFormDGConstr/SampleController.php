...
namespace Samples\EmbeddedSenderWithFormDGConstr;
...
class SampleController implements SampleControllerInterface
{
     ...
     */
    private const DOCUMENT_GROUP_TEMPLATE_ID = '625ae557229d48d78728c281f46d3d8494f235a4';

    public function handleGet(Request $request): Response
    {
        return new Response(
            view('EmbeddedSenderWithFormDGConstr::index')->render(),
            200,
            [
    ...
    private function createEmbeddedSendingUrl(ApiClient $apiClient, string $documentGroupId): array
    {
        ...
        $redirectUrl = config('app.url')
            . '/samples/EmbeddedSenderWithFormDGConstr?' .
            http_build_query([
                'page' => 'status-page',
